...
export async function fetchBills(params: URLSearchParams, correlationId: string): Promise<Bill[]> {
...
export async function fetchBillById(id: string, correlationId: string): Promise<Bill | null> {
